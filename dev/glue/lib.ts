...
import { eachChunk, hashFile } from "./util"
...
class Emitter {
    ...
    constructor(public readonly w: Writer, private readonly path: string, initial: string = "/* This file has been autogenerated */") {
        this.line(initial)
    }
    ...
    line(s: string = ``) {
        this.w.write(this.path, "\t".repeat(this._indent) + s + "\n")
