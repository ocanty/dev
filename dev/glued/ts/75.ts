...
export class Acct 
extends _M.Model implements _Acct {	constructor(o?: _M.DeepPartial<_Acct>) {
...
export class AcctHead 
extends _M.Model implements _AcctHead {	constructor(o?: _M.DeepPartial<_AcctHead>) {
