...
export class Config 
extends _M.Model implements _Config {	constructor(o?: _M.DeepPartial<_Config>) {
...
export class K 
extends _M.Model implements _K {	constructor(o?: _M.DeepPartial<_K>) {
...
export class Kv 
extends _M.Model implements _Kv {	constructor(o?: _M.DeepPartial<_Kv>) {
