...
extends _M.Model implements _Request {	constructor(o?: _M.DeepPartial<_Request>) {
...
extends _M.Model implements _Response {	constructor(o?: _M.DeepPartial<_Response>) {
...
export class Error 
extends _M.Model implements _Error {	constructor(o?: _M.DeepPartial<_Error>) {
...
export class Result 
extends _M.Model implements _Result {	constructor(o?: _M.DeepPartial<_Result>) {
